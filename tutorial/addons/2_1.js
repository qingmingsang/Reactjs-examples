...
/***/ function(module, exports, __webpack_require__) {
	...
	var WithoutLink = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('input', { type: 'text', value: valueLink.value, onChange: handleChange });
	  }
	});

	ReactDOM.render(React.createElement(WithoutLink, null), document.getElementById('example'));
