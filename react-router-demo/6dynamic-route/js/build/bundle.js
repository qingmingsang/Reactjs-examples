...
/***/ function(module, exports, __webpack_require__) {
	...
	var _master = __webpack_require__(220);
	...
	var _factors = __webpack_require__(225);

	var _factors2 = _interopRequireDefault(_factors);

	var _factor = __webpack_require__(231);
	...
	var _noMatch = __webpack_require__(233);

	var _noMatch2 = _interopRequireDefault(_noMatch);

	var _state = __webpack_require__(223);
	...
	var userRoutes = [{
	    path: '/factors',
	    component: _factors2.default,
	    childRoutes: [{
	        path: '/factors/:id',
	        component: _factor2.default
	    }]
	}];
	...
	var routes = [{
	    ...
	    childRoutes: _state2.default.role === 'user' ? userRoutes : adminRoutes
	}, {
	    path: '/login',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Master = function (_React$Component) {
	    ...
	    function Master(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Master).call(this, props));
	    ...
	    _createClass(Master, [{
	        ...
	        value: function render() {
	            if (this.state.role === 'user') {
	                this.navLinks = [{ text: '首页', path: '/' }, { text: '监测因素', path: '/factors' }];
	            } else if (this.state.role === 'admin') {
	                this.navLinks = [{ text: '首页', path: '/' }, { text: '用户管理', path: '/users' }];
	            }

	            return _react2.default.createElement(
	                'div',
	                { style: { height: '100%' } },
	                _react2.default.createElement(_header2.default, { title: 'Brand', links: this.navLinks }),
	                _react2.default.createElement(
	                    'div',
	                    { style: { height: '100%' } },
	                    this.props.children
	                ),
	                _react2.default.createElement(_footer2.default, { text: 'copyright 2016' })
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    factors: [{ id: 5, name: '温湿度监测' }, { id: 6, name: '雨量监测' }, { id: 9, name: '表面位移监测' }, { id: 10, name: '内部位移监测' }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _factorSelector = __webpack_require__(226);

	var _factorSelector2 = _interopRequireDefault(_factorSelector);
	...
	var Factors = function (_React$Component) {
	    ...
	    function Factors(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Factors).call(this, props));

	        _initialiseProps.call(_this);

	        _this.state = {
	            factors: _state2.default.factors
	        };
	        return _this;
	    }
	...
	var _initialiseProps = function _initialiseProps() {
	    ...
	    this.renderTab = function () {
	        var idInRouteParams = Number(_this2.props.params.id);
	        console.log(idInRouteParams);
	        return _this2.state.factors.map(function (f) {
	            return _react2.default.createElement(
	                'li',
	                { className: f.id === idInRouteParams ? 'active' : '' },
	                _react2.default.createElement(
	                    _reactRouter.Link,
	                    { key: f.id, to: '/factors/' + f.id },
	                    f.name
	                )
	            );
	        });
	    ...
	    this.redirectDefault = function (props) {
	        if (!props.params.id && _this2.state.factors && _this2.state.factors.length > 0) {
	            _this2.context.router.push('/factors/' + _this2.state.factors[0].id);
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _humiture = __webpack_require__(227);

	var _humiture2 = _interopRequireDefault(_humiture);

	var _rain = __webpack_require__(228);

	var _rain2 = _interopRequireDefault(_rain);

	var _surface = __webpack_require__(229);

	var _surface2 = _interopRequireDefault(_surface);

	var _deep = __webpack_require__(230);
	...
	var FactorSelector = function (_React$Component) {
	    _inherits(FactorSelector, _React$Component);

	    function FactorSelector(props) {
	        _classCallCheck(this, FactorSelector);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FactorSelector).call(this, props));
	    }

	    _createClass(FactorSelector, [{
	        key: 'render',
	        value: function render() {
	            if (this.props.factorId === 5) {
	                return _react2.default.createElement(_humiture2.default, null);
	            } else if (this.props.factorId === 6) {
	                return _react2.default.createElement(_rain2.default, null);
	            } else if (this.props.factorId === 9) {
	                return _react2.default.createElement(_surface2.default, null);
	            } else if (this.props.factorId === 10) {
	                return _react2.default.createElement(_deep2.default, null);
	            } else {
	...
	FactorSelector.propTypes = {
	    factorId: _react2.default.PropTypes.number.isRequired
	};
	exports.default = FactorSelector;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Humiture = function (_React$Component) {
	    _inherits(Humiture, _React$Component);

	    function Humiture() {
	        _classCallCheck(this, Humiture);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Humiture).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rain = function (_React$Component) {
	    ...
	    function Rain() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Rain).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Deep = function (_React$Component) {
	    _inherits(Deep, _React$Component);

	    function Deep() {
	        _classCallCheck(this, Deep);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Deep).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Factor = function (_React$Component) {
	    _inherits(Factor, _React$Component);

	    function Factor() {
	        _classCallCheck(this, Factor);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Factor).apply(this, arguments));
	    }

	    _createClass(Factor, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(_factorSelector2.default, { factorId: Number(this.props.params.id) });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoMatch = function (_React$Component) {
	    ...
	    function NoMatch(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NoMatch).call(this, props));
