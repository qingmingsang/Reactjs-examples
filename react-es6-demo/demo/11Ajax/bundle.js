...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserGist = function (_React$Component) {
	    ...
	    function UserGist(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UserGist).call(this, props));
	    ...
	    _createClass(UserGist, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.serverRequest = _jquery2.default.get(this.props.source, function (result) {
	...
	_reactDom2.default.render(_react2.default.createElement(UserGist, { source: 'https://api.github.com/users/octocat/gists' }), document.getElementById('example'));
